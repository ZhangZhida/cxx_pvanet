...
class SolverParameter : public ::google::protobuf::Message {
 public:
  ...
  inline int plateau_winsize_size() const;
  inline void clear_plateau_winsize();
  static const int kPlateauWinsizeFieldNumber = 41;
  inline ::google::protobuf::int32 plateau_winsize(int index) const;
  inline void set_plateau_winsize(int index, ::google::protobuf::int32 value);
  inline void add_plateau_winsize(::google::protobuf::int32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
...
class SolverState : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_minimum_loss() const;
  inline void clear_minimum_loss();
  static const int kMinimumLossFieldNumber = 5;
  inline float minimum_loss() const;
  inline void set_minimum_loss(float value);

  // optional int32 iter_last_event = 6 [default = 0];
  inline bool has_iter_last_event() const;
  inline void clear_iter_last_event();
  static const int kIterLastEventFieldNumber = 6;
  inline ::google::protobuf::int32 iter_last_event() const;
  inline void set_iter_last_event(::google::protobuf::int32 value);
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const int kProposalParamFieldNumber = 8266713;
